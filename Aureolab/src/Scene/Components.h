...
struct MeshRendererComponent {
	enum class Visualization { SolidColor, Normal, UV, Depth, VertexColor, FrontAndBackFaces, Checkers, PointLight, HemisphericalLight, };
	static inline const char* visNames[] = { "SolidColor", "Normal", "UV", "Depth", "VertexColor", "FrontAndBackFaces", "Checkers", "PointLight", "HemisphericalLight"}; // for GUI
	struct Depth { 
		float max = 5.0f; 
		float pow = 2.0f; 
